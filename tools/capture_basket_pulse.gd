...
# this never touches a player's own farm, and one screenshot — of the
# shipped default bar, deliberately, since the pulse needs no treatment
# ruling (Q-123) to show.
extends Node2D
