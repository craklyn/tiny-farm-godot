...
async function renderDesign() {
  ...
  const frag = h(`<h1>🎨 Design Studio</h1>
    ...
    <div class="grid cols4 method">
      ...
      <div class="card"><b>⚖️ Decisions with tiers</b><p class="small muted">Chapters cite decisions; they never re-argue them. Every decision is settled, provisional (with adjustment conditions), or deferred (with a trigger).</p></div>
